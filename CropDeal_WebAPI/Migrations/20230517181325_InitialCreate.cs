        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Userid = table.Column<int>(type: "int", nullable: false),
                    Crop_Details_id = table.Column<int>(type: "int", nullable: false),
                    CropdetailCrop_Details_id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.CropdetailCrop_Details_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User_id = table.Column<int>(type: "int", nullable: false),
                    Userid = table.Column<int>(type: "int", nullable: false),
                    Crop_Detaila_id = table.Column<int>(type: "int", nullable: false),
                    CropdetailCrop_Details_id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
